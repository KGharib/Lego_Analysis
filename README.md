...
<br><br>
### Content:
This dataset contains the LEGO Parts/Sets/Colors and Inventories of every official LEGO set in the Rebrickable database. These files are current as of July 2017. We will also find another dataset to use alongside it that contains prices
Acknowledgements:
